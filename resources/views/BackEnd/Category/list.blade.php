                        ...
                        <div class="panel blank-panel">
                            <div class="panel-heading">
                                <div class="panel-options">
                                    ...
                                    <li><a class="nav-link active" href="#tab-1" data-toggle="tab">Danh sách danh mục</a>
                                         </li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div id="nestable-menu">
                                                    <button type="button" data-action="expand-all" class="btn btn-white btn-sm">Mở rộng</button>
                                                    <button type="button" data-action="collapse-all" class="btn btn-white btn-sm">Thu gọn</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ibox ">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Chỉnh sửa các danh mục</small>
                </div>
                <form id="sample_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="action_button" id="action_button" class="ladda-button btn btn-primary"
                            data-style="expand-right">Lưu thay dổi</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content animated flipInY">
                <div class="modal-header">
                    <button style="margin-top: -10%; margin-right: -5%;" type="button" class="close"
                     ...
                     <small class="font-bold">Thông tin các danh mục.</small>
                </div>
                <input type="hidden" name="hidden_id" id="hidden_id">
                <div class="modal-body">
                    <p>Bạn có chắc chắn muốn xóa "<span id="body"></span>"?</p>
                </div>
