        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Thêm thanh trượt quảng cáo điện thoại</small>
                </div>
                <form id="sample_form" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Miêu tả <sup class="text-danger">*</sup></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Trạn thái <sup class="text-danger">*</sup></label>
                            <div class="col-sm-10">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#add_slider').click(function(){
                ...
                $("#desc").val("");
                $("#name_slider").val("");
                $('.modal-title').text("Thêm thanh trượt");
                $('#action').val("Add");
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if (response.status == 404) {
                            ...
                            $('.modal-title').text("Chỉnh sửa thanh trượt");
                            $('#action').val("Edit");
                        }
                    }
                });
