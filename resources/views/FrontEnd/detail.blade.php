        ...
        <div class="container">
            <div class="row">
                ...
                <div class="breadcrumbs">
                    <ul>
                        <li><a href="{{ route('home') }}" title="Go to Home Page">Trang chủ</a><span>/</span></li>
                                        ...
                                        <div class="add-to-box">
                                            <div class="add-to-cart">
                                                ...
                                                <button class="button btn-cart"
                                                    ...
                                                    title="Add to Cart" type="submit">Thêm giỏ hàng</button>
                                            </div>
                                ...
                                <div class="slider-items-products">
                                    ...
                                    <div class="home-block-inner">
                                        <div class="block-title">
                                            <h2 style="margin: 0; line-height: 1.2;">Sản phẩm liên quan</h2>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="item-content">
                                                                        ...
                                                                        <div class="action">
                                                                            <button class="button btn-cart" type="button"
                                                                                ...
                                                                                {{ $pro_rel->product_quantity > 0 ? '' : 'disabled' }}><span>Thêm giỏ hàng</span> </button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
