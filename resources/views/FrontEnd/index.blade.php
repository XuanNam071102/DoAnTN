    ...
    <div class="row">
        <div class="col-md-3 col-md-4 col-sm-3 hidden-xs">
            <div class="side-banner">
                <img  src="{{ asset('frontend/images/side-banner.jpg') }}"
                    alt="banner">
                </div>
        </div>
                                ...
                                <div class="product-bestseller-list">
                                    <div class="tab-container">
                                        ...
                                        <div class="tab-panel active" id="tab-0">
                                            ...
                                            @else
                                            <h4 style="text-align: center; color: #777;">Không tìm thấy sản phẩm</h4>
                                            @endif
                                        </div>
                                        <!-- tab product -->
                                        @foreach($new_category as $new_cate)
                        ...
                        <div class="slider-items-products">
                            <div class="bestsell-block">
                                <div class="block-title">
                                    <h2 style="padding: 10px 0;">Bán chạy nhất</h2>
                                </div>
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="action">
                                                                <button class="button btn-cart add_cart" type="button"
                                                                    ...
                                                                    data-original-title="Add to Cart"><span>Thêm giỏ hàng</span> </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="item-content">
                                            ...
                                            <div class="action">
                                                <button data-original-title="Add to Cart" title="" type="button" data-id_pro="{{ $item->product_id }}"
                                                    class="button btn-cart add_cart"><span>Thêm giỏ hàng</span> </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="blog-outer-container">
            ...
            <div class="blog-inner">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <h4 class="blog-preview_title"><a href="blog_single_post.html">Hướng dẫn chọn mua điện thoại</a></h4>
                         <ul class="post-meta">
                         ...
                         <div class="blog-preview_desc">Khi mua điện thoại, hãy xác định nhu cầu sử dụng, 
                            chọn hệ điều hành phù hợp (iOS hoặc Android), kiểm tra các thông số kỹ thuật cần thiết
                            , xem xét ngân sách và đọc đánh giá từ người dùng để có quyết định chính xác..</div>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6">
                     ...
                     <div class="blog-preview_info">
                         ...
                         <div class="blog-preview_desc">Galaxy A14 5G : Giá rẻ nhất, có 5G và màn hình 6.5 inch.
                            Galaxy A25 5G : Tầm trung, màn hình Super AMOLED 120Hz và camera 50MP.
                            Galaxy A34 5G : Màn hình lớn 6.6 inch, pin 5,000mAh,vv...</div>
                         <a class="blog-preview_btn" href="blog_single_post.html">ĐỌC THÊM</a>
                     </div>
                </div>
            </div>
