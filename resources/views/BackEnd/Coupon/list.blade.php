        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Chỉnh sửa phiếu giảm giá của cửa hàng</small>
                </div>
                <form id="sample_form" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Ngày <sup class="text-danger">*</sup></label>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Số giảm giá </label>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row){
                            ...
                            if (mm < date_end_mm && date_end_yyyy >= yyyy) {
                                return "<span class='expiry tag-style'>Còn Hạn Sử Dụng</span>";
                            }else if (mm == date_end_mm && date_end_yyyy == yyyy) {
                                if (date_end_dd >= dd) {
                                    return "<span class='expiry tag-style'>Còn Hạn Sử Dụng</span>";
                                }else{
                                    return "<span class='expired tag-style'>Hết hạn</span>";
                                }
                            }else{
                                return "<span class='expired tag-style'>Hết hạn</span>";
                            }
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if (response.status == 404) {
                            ...
                            $('#image_show').html('');
                            $('.modal-title').text("Chỉnh sửa phiếu giảm giá");
                            $('#action').val("Edit");
                        }
                    }
                });
