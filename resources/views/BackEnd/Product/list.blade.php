                                                ...
                                                <div class="col-lg-6">
                                                    <div class="ibox" id="ibox2" style="margin-top: 5%;">
                                                        ...
                                                        <div id="data_3"
                                                            ...
                                                            <label class="col-sm-2 col-form-label">Ngày Sale</label>
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="col-sm-2 col-form-label">Giá tiền <sup
                                                                    class="text-danger">*</sup></label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="ibox ">
                                                        <div
                                                            ...
                                                            <label class="font-normal">Miêu tả <sup
                                                                    class="text-danger">*</sup></label>
            ...
            <div class="modal-content animated flipInY">
                <div class="modal-header">
                    <button style="margin-top: -10%; margin-right: -5%;" type="button" class="close"
                     ...
                     <small class="font-bold">Bạn muốn xóa.</small>
                </div>
                <input type="hidden" name="hidden_id_product" id="hidden_id_product">
                <div class="modal-body">
                    <p>Bạn có chắc chắn muốn xóa "<span id="body_product"></span>"?</p>
                </div>
