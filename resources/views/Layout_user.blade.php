                                ...
                                <div class="links">
                                    ...
                                    <div class="dropdown block-company-wrapper hidden-xs">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li role="presentation"><a href="{{ route('history.index') }}"> Lịch sử đơn hàng </a></li>
                                            @endif
                                        </ul>
                                    </div>
                                    <!-- End Header Company -->
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-3 hidden-xs category-search-form">
                        <div class="search-box">
                            <form id="search_mini_form" action="{{ route('home.create') }}" method="get">
                                ...
                                <input id="search" type="text" name="search" placeholder="Tìm kiếm sản phẩm"
                            ...
                            <div class="col-lg-7 col-md-9 col-xs-12 col-sm-8 offer-block">
                                <div class="feature-box first">
                                 ...
                                 <div class="feature-box last">
                                     <div class="content">
                                         <h3>Đường dây nóng 0377517895</h3>
                                     </div>
                                 </div>
                             </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <form>
                                <div>
                                    ...
                                    <button type="submit" style="height: 40px; display: inline-block;">Đăng ký</button>
                                </div>
                            </form>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                         ...
                         <div class="col-md-3 col-sm-6">
                             ...
                             <address>
                                <i class="add-icon">&nbsp;</i>304 Lê Thanh Nghị, Đà Nẵng, <br>
                                &nbsp;VN 12345 Việt Nam
                            </address>
                                 <div class="phone-footer"><i class="phone-icon">&nbsp;</i> 0377517895
                                 </div>
                                 <div class="email-footer"><i class="email-icon">&nbsp;</i> <a
                                         href="mailto:abc@magikcommerce.com">maunam0711@gmail.com</a> </div>
                             </div>
                        </div>
                    </div>
                </div>
