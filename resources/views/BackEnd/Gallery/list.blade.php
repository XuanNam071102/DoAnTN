...
@section('script')
    ...
    <script>
        ...
        Dropzone.options.dropzoneForm = {
            ...
            maxFilesize: 2, // MB
            dictDefaultMessage: "<strong>Thả tệp vào đây hoặc nhấn để tải lên. </strong></br> (Đây chỉ là vùng thả demo. Các tệp đã chọn không thực sự được tải lên.)",
