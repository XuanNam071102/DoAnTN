                                    ...
                                    <h3>Mã Giảm Giá</h3>
                                        <form method="post" action="{{ route('cart.store') }}" id="discount-coupon-form">
                                            ...
                                            <button value="Apply Coupon"
                                                class="button coupon dscoupon" {{ Session::get('coupon') ? 'disabled' : '' }} title="Apply Coupon" type="submit"><span>Áp dụng</span></button>
                                        </form>
                                    </div>
                                </div>
                                        ...
                                        <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                                            ...
                                            <tbody id="cartTotal">
                                                <tr>
                                                    ...
                                                    <td class="a-right"><span class="price">0 vnđ</span>
                                                </td>
                                                <tr>
                                                    <td colspan="1" class="a-left"> Thuế </td>
                                                    <td class="a-right"><span class="price">0 vnđ</span></td>
                                                </tr>
                                                <tr>
